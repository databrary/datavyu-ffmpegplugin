...
public class FloatDataValueTest extends DataValueTest {
    ...
    @Override public DataValue getInstance() {
        return fdv;
    }
     ...
     */
    @BeforeMethod public void setUp() throws SystemErrorException {
        db = new ODBCDatabase();
     ...
     */
    @Test @Override public void testUpdateForFargChange() throws Exception {
    }
     ...
     */
    @Test @Override public void testUpdateSubRange() throws Exception {
    }
     ...
     * @throws org.openshapa.models.db.legacy.SystemErrorException on failure.
     */
    @Test public void test1ArgConstructor() throws SystemErrorException {
     ...
     * @throws org.openshapa.models.db.legacy.SystemErrorException on failure.
     */
    @Test public void test2ArgConstructor() throws SystemErrorException {
        ...
        assertEquals(float_value.getItsValue(), float_value.getDefault(),
            DELTA);
        ...
        assertEquals(float_value2.getItsValue(), float_value2.getDefault(),
            DELTA);
     ...
     * @throws org.openshapa.models.db.legacy.SystemErrorException on failure.
     */
    @Test public void test3ArgConstructor() throws SystemErrorException {
    ...
    public void test3ArgConstructorFailure1() throws SystemErrorException {
        FloatDataValue f_value = new FloatDataValue(db, DBIndex.INVALID_ID,
                1.0);
    }
     ...
     * @throws org.openshapa.models.db.legacy.SystemErrorException on failure.
     */
    @Test public void testCopyConstructor() throws SystemErrorException {
     ...
     * @throws org.openshapa.models.db.legacy.SystemErrorException on failure.
     */
    @Test public void testGetItsValue() throws SystemErrorException {
     ...
     * @throws org.openshapa.models.db.legacy.SystemErrorException on failure.
     */
    @Test public void testSetItsValue() throws SystemErrorException {
        FloatDataValue f_value = new FloatDataValue(db, ffa2.getID(), 50.0);
     ...
     * @throws org.openshapa.models.db.legacy.SystemErrorException on failure.
     */
    @Test public void testToString() throws SystemErrorException {
        FloatDataValue f_value = new FloatDataValue(db, ffa2.getID(), 50.0);
     ...
     */
    @Test public void testToDBString() throws SystemErrorException {
        String testDBString0 = "(FloatDataValue (id 0) " + "(itsFargID 8) "
            + "(itsFargType FLOAT) " + "(itsCellID 0) " + "(itsValue 50.0) "
            + "(subRange true) " + "(minVal -100.0) " + "(maxVal 100.0))";
     ...
     * @throws org.openshapa.models.db.legacy.SystemErrorException on failure.
     */
    @Test public void testCoerceToRange() throws SystemErrorException {
     ...
     * @throws org.openshapa.models.db.legacy.SystemErrorException on failure.
     */
    @Test public void testConstruct() throws SystemErrorException {
        FloatDataValue test = FloatDataValue.Construct(db, 50.0);
        assertEquals(test.getItsValue(), 50.0);
    }

    @Test public void testHashCode() throws SystemErrorException {
    ...
    @Test public void testEquals() throws SystemErrorException,
     ...
     *    - None.
     */
    @Test public void Test1ArgConstructor() {
        String testBanner =
        ...
        if ((db == null) || (fdv == null) || (!completed)
            ...
            if (verbose) {
                ...
                if (fdv == null) {
                    outStream.print("new FloatDataValue(db) returned null.\n");
                }
        ...
        if (failures == 0) {
            failures += DataValueTest.Verify1ArgInitialization(db, fdv,
                    outStream, verbose);

            try {
                Double fdvitsValue = (Double) PrivateAccessor.getField(fdv,
                        "itsValue");
                Double fdvItsDefault = (Double) PrivateAccessor.getField(fdv,
                        "ItsDefault");
                Double fdvmaxVal = (Double) PrivateAccessor.getField(fdv,
                        "maxVal");
                Double fdvminVal = (Double) PrivateAccessor.getField(fdv,
                        "minVal");
                ...
                if (!FloatUtils.closeEnough(fdvmaxVal, 0.0)) {
                    ...
                    if (verbose) {
                        outStream.printf(
                            "bad initial value of fdv.maxVal: %f.\n",
                            fdvmaxVal);
                    }
                }
                ...
                if (!FloatUtils.closeEnough(fdvminVal, 0.0)) {
                    ...
                    if (verbose) {
                        outStream.printf(
                            "bad initial value of fdv.minVal: %f.\n",
                            fdvminVal);
                    }
                }
            } catch (Throwable th) {
        ...
        if (failures == 0) {
            ...
            if ((fdv != null) || (completed) || (!threwSystemErrorException)) {
                failures++;
                ...
                if (verbose) {
                    ...
                    if (!threwSystemErrorException) {
                        outStream.print(
                            "new FloatDataValue(null) failed to throw "
    ...
    @Test public void Test2ArgConstructor() throws SystemErrorException {
        ...
        if ((db == null) || (float_mve == null) || (ffa == null)
                || (fdv == null) || (float_mve_sr == null) || (ffa_sr == null)
                || (fdv_sr == null) || (!completed)
                || (threwSystemErrorException)) {
            failures++;
        ...
        if (failures == 0) {
            failures += DataValueTest.Verify2PlusArgInitialization(db, ffa, fdv,
                    outStream, verbose, "fdv");
            ...
            failures += DataValueTest.Verify2PlusArgInitialization(db, ffa_sr,
                    fdv_sr, outStream, verbose, "fdv_sr");
            ...
            try {
                Double fdv_sritsValue = (Double) PrivateAccessor.getField(
                        fdv_sr, "itsValue");
                Double fdv_srItsDefault = (Double) PrivateAccessor.getField(
                        fdv_sr, "ItsDefault");
                Double fdv_srmaxVal = (Double) PrivateAccessor.getField(fdv_sr,
                        "maxVal");
                Double fdv_srminVal = (Double) PrivateAccessor.getField(fdv_sr,
                        "minVal");
    ...
    @Test public void Test3ArgConstructor() throws SystemErrorException {
        ...
        if ((db == null) || (float_mve == null) || (ffa == null)
                || (fdv == null) || (float_mve_sr == null) || (ffa_sr == null)
                || (fdv_sr0 == null) || (fdv_sr1 == null) || (!completed)
                || (threwSystemErrorException)) {
            failures++;
        ...
        if (failures == 0) {
            ...
            failures += DataValueTest.Verify2PlusArgInitialization(db, ffa_sr,
                    fdv_sr0, outStream, verbose, "fdv_sr0");
            ...
            try {
                Double fdv_sr0itsValue = (Double) PrivateAccessor.getField(
                        fdv_sr0, "itsValue");
                Double fdv_sr0ItsDefault = (Double) PrivateAccessor.getField(
                        fdv_sr0, "ItsDefault");
                Double fdv_sr0maxVal = (Double) PrivateAccessor.getField(
                        fdv_sr0, "maxVal");
                Double fdv_sr0minVal = (Double) PrivateAccessor.getField(
                        fdv_sr0, "minVal");
                ...
                if (!FloatUtils.closeEnough(fdv_sr0maxVal,
                            ffa_sr.getMaxVal())) {
                    failures++;
                ...
                if (!FloatUtils.closeEnough(fdv_sr0minVal,
                            ffa_sr.getMinVal())) {
                    failures++;
                ...
                if (verbose) {
                    outStream.printf(
                        "Problem with PrivateAccessor and fdv_sr.");
                }
            }

            failures += DataValueTest.Verify2PlusArgInitialization(db, ffa_sr,
                    fdv_sr1, outStream, verbose, "fdv_sr1");
            ...
            try {
                Double fdv_sr1itsValue = (Double) PrivateAccessor.getField(
                        fdv_sr1, "itsValue");
                Double fdv_sr1maxVal = (Double) PrivateAccessor.getField(
                        fdv_sr1, "maxVal");
                Double fdv_sr1minVal = (Double) PrivateAccessor.getField(
                        fdv_sr1, "minVal");

                if (!FloatUtils.closeEnough(fdv_sr1itsValue,
                            ffa_sr.getMaxVal())) {
                    failures++;
                ...
                if (!FloatUtils.closeEnough(fdv_sr1maxVal,
                            ffa_sr.getMaxVal())) {
                    failures++;
                ...
                if (!FloatUtils.closeEnough(fdv_sr1minVal,
                            ffa_sr.getMinVal())) {
                    failures++;
                ...
                if (verbose) {
                    outStream.printf(
                        "Problem with PrivateAccessor and fdv_sr1.");
                }
            }
        }
     ...
     *    - None.
     */
    @Test public void TestAccessors() throws SystemErrorException {
        String testBanner =
        ...
        if ((db == null) || (float_mve == null) || (ffa == null)
                || (fdv0 == null) || (matrix_mve == null) || (ufa == null)
                || (fdv1 == null) || (fdv2 == null) || (!completed)
                || (threwSystemErrorException)) {
            failures++;
    ...
    @Test public void TestCopyConstructor() throws SystemErrorException {
        ...
        if (failures == 0) {
            ...
            if ((fdv_copy == null) || (fdv_sr0_copy == null)
                    || (fdv_sr1_copy == null) || (!completed)
                    || (threwSystemErrorException)) {
                failures++;
        ...
        if (failures == 0) {
            ...
            failures += DataValueTest.VerifyDVCopy(fdv_sr0, fdv_sr0_copy,
                    outStream, verbose, "fdv_sr0", "fdv_sr0_copy");

            failures += DataValueTest.VerifyDVCopy(fdv_sr1, fdv_sr1_copy,
                    outStream, verbose, "fdv_sr1", "fdv_sr1_copy");
        }
        ...
        if (failures == 0) {
            ...
            if ((fdv != null) || (completed) || (!threwSystemErrorException)) {
                ...
                if (verbose) {
                    ...
                    if (completed) {
                        outStream.print(
                            "new FloatDataValue(null) completed.\n");
                    }
     ...
     *    - None.
     */
    @Test public void TestToStringMethods() throws SystemErrorException {
        String testBanner =
            "Testing toString() & toDBString()                                ";
        String passBanner = "PASSED\n";
        String failBanner = "FAILED\n";
        String testString0 = "200.000000";
        String testDBString0 = "(FloatDataValue (id 100) " + "(itsFargID 2) "
            + "(itsFargType FLOAT) " + "(itsCellID 500) " + "(itsValue 200.0) "
            + "(subRange true) " + "(minVal -1000.0) " + "(maxVal 1000.0))";
        String testString1 = "2000.000000";
        String testDBString1 = "(FloatDataValue (id 101) " + "(itsFargID 8) "
            + "(itsFargType UNTYPED) " + "(itsCellID 501) "
            + "(itsValue 2000.0) " + "(subRange false) " + "(minVal 0.0) "
            + "(maxVal 0.0))";
        String systemErrorExceptionString = null;
        boolean completed = false;
        boolean pass = true;
    ...
    public static int VerifyFloatDVCopy(final FloatDataValue base,
        final FloatDataValue copy, final java.io.PrintStream outStream,
        final boolean verbose, final String baseDesc, final String copyDesc) {
        int failures = 0;
        ...
        if (base == null) {
            ...
            try {
                Double baseitsValue = (Double) PrivateAccessor.getField(base,
                        "itsValue");
                Double copyitsValue = (Double) PrivateAccessor.getField(copy,
                        "itsValue");
                Double basemaxVal = (Double) PrivateAccessor.getField(base,
                        "maxVal");
                Double copymaxVal = (Double) PrivateAccessor.getField(copy,
                        "maxVal");
                Double baseminVal = (Double) PrivateAccessor.getField(base,
                        "minVal");
                Double copyminVal = (Double) PrivateAccessor.getField(copy,
                        "minVal");
                ...
                if (!FloatUtils.closeEnough(baseitsValue, copyitsValue)) {
                    ...
                    if (verbose) {
                        outStream.printf(
                            "%s.toString() doesn't match %s.toString().\n",
                            baseDesc, copyDesc);
                    }
                } else if (base.toDBString().compareTo(copy.toDBString())
                        != 0) {
                    failures++;
                    ...
                    if (verbose) {
                        ...
                        outStream.printf(
                            "%s.toDBString() = \"%s\".\n%s.toDBString() = \"%s\".\n",
                            baseDesc, base.toDBString(), copyDesc,
                            copy.toDBString());
                    }
                }
            } catch (Throwable th) {
                ...
                if (verbose) {
                    outStream.printf(
                        "Problem with PrivateAccessor and base or copy.");
                }
            }
        }
