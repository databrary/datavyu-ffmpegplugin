...
public final class UITrackViewerTest extends OpenSHAPATestClass {
    ...
    /**
     * Test that the needle can't be dragged beyond the start or the end.
     */
    @Test
    public void testNeedleRangeOfMovement() {
        System.err.println(new Exception().getStackTrace()[0].getMethodName());
        // 1. Get Spreadsheet
        JPanelFixture jPanel = UIUtils.getSpreadsheet(mainFrameFixture);
        SpreadsheetPanelFixture ssPanel =
        ...
        //4. Drag needle beyond end of track
        ...
        //Check that needle is only at end of track
        Assert.assertEquals(needle.getCurrentTimeAsTimeStamp(), "00:01:00:000");

        //4. Drag needle beyond start of track
