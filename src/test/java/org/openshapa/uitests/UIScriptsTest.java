...
public final class UIScriptsTest extends OpenSHAPATestClass {
    ...
    @Test public void testModifySpreadsheet() throws IOException {
        ...
        final File modifyFile = new File(testFolder
                + "/ui/find_and_replace.rb");
    ...
    @Test public void testDuplicateRecentScripts() {
        ...
        Assert.assertTrue(script1.exists(), "Expecting script1.rb to exist.");

        final File script2 = new File(testFolder + "/ui/script2.rb");
        Assert.assertTrue(script2.exists(), "Expecting script2.rb to exist.");
        ...
        JMenuItemFixture recentScriptMenu = mainFrameFixture.menuItemWithPath(
                "Script", "Run recent script").click();
        JPopupMenu recentScripts = (JPopupMenu)
            recentScriptMenu.component().getSubElements()[0];
        ...
        //Check recent scripts
        recentScriptMenu = mainFrameFixture.menuItemWithPath("Script",
                "Run recent script").click();
        recentScripts = (JPopupMenu)
            recentScriptMenu.component().getSubElements()[0];
