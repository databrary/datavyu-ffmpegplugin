...
implements InternalMatrixVocabElementListener {
     ...
     * toMODBFile()
     *
     * Write the MacSHAPA ODB style definition of the column predicate and its
               ...
               java.io.IOException
    {
        ...
        else
        {
            if ( ( this.mveName == null ) ||
                 ( this.mveName.length() == 0 ) )
            {
                /* column name undefined or of zero length!! */
                throw new SystemErrorException(mName + "mveName undefined");
            }
