...
public class TimescalePainter extends JComponent {
    ...
    @Override public void paintComponent(final Graphics g) {
        ...
        paintMarkers(g2d, plottedMarkers, hourIntervalsInMS, majorMarkerWidth,
            hourIntervalsMarkerHeight, 150000, 130000, hoursColor,
            backgroundColor);
        paintMarkers(g2d, plottedMarkers, 10 * minuteIntervalsInMS,
            minorMarkerWidth, hourIntervalsMarkerHeight, 140000, 30000,
            hoursColor, backgroundColor);
        paintMarkers(g2d, plottedMarkers, minuteIntervalsInMS, majorMarkerWidth,
            minuteIntervalsMarkerHeight, 15000, 2000, minutesColor,
            backgroundColor);
        paintMarkers(g2d, plottedMarkers, 10 * secondIntervalsInMS,
            minorMarkerWidth, minuteIntervalsMarkerHeight, 4000, 900,
            minutesColor, backgroundColor);
        paintMarkers(g2d, plottedMarkers, secondIntervalsInMS, majorMarkerWidth,
            secondIntervalsMarkerHeight, 400, 1, secondsColor, backgroundColor);
        paintMarkers(g2d, plottedMarkers, secondIntervalsInMS / 10,
            minorMarkerWidth, secondIntervalsMarkerHeight, 60, 1, secondsColor,
            backgroundColor);
        paintMarkers(g2d, plottedMarkers, secondIntervalsInMS / 100,
     ...
     */
    private void paintMarkers(final Graphics2D g2d,
        ...
        final double currentMsPerPx = (double) viewableModel.getIntervalTime()
        ...
        for (long plotTime = viewableModel.getZoomWindowStart() + leftPadTime;
                plotTime <= viewableModel.getZoomWindowEnd();
                plotTime += intervalTime) {
