...
public final class DataControllerV extends OpenSHAPADialog implements
    ...
    private void initComponents() {
        ...
        // Timestamp label
        timestampLabel.setFont(new Font("Tahoma", 1, 11));
        ...
        gridButtonPanel.add(timestampLabel, "span 3, split");

        jLabel1.setText("@");
        gridButtonPanel.add(jLabel1, "");
        ...
        lblSpeed.setText("0");
        gridButtonPanel.add(lblSpeed, "gapafter 0px");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel2.setText("x");
        gridButtonPanel.add(jLabel2, "wrap");
        ...
        createNewCellSettingOffset
                .setPressedIcon(new javax.swing.ImageIcon(
                        getClass()
                                .getResource(
                                        "/icons/DataController/eng/create-new-cell-and-set-onset-selected.png")));
