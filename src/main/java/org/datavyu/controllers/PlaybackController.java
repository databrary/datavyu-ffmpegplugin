...
import org.datavyu.logging.PlaybackLogging;
...
import org.datavyu.views.LinuxJFC;
import org.datavyu.views.MacOSJFC;
import org.datavyu.views.PlaybackV;
import org.datavyu.views.PluginChooser;
import org.datavyu.views.WindowsJFC;
...
public final class PlaybackController implements PlaybackListener,
    ...
    public PlaybackController() {
        ...
        playbackView = new PlaybackV(Datavyu.getApplication().getMainFrame(),
        ...
        Runnable task = new Runnable() {
                ...
                public void run() {
                    ...
                    ResourceMap resourceMap = Application.getInstance(
                            	org.datavyu.Datavyu.class).getContext()
            ...
            executor.submit(new Runnable() {
                    @Override public void run() {
                        ...
                        dataViewer.setDatastore(
                            Datavyu.getProjectController().getDB());
