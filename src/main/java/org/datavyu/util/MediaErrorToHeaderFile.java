 ...
 *
 * <p>This file is only used during the compile process.
 *
 * <p>TODO(fraudies): Run this during the build with maven and add arguments for output path/file
 */
public class MediaErrorToHeaderFile {
  public static void main(String[] args) {
    ...
    System.out.println(
        "Generated header file for '"
            + MediaError.class.getName()
            + "' and wrote it to '"
            + fileName
            + "'");
  }
