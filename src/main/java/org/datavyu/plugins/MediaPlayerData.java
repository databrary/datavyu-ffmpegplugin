...
/**
 * This provides the interface to the media player data when we
 * decide to play back data through java.
 *
 * <p>Otherwise, we play back data natively.
 */
public interface MediaPlayerData extends MediaPlayer {
  ...
  /**
   * Returns the output audio format that the audio data is
   * formatted in
   *
