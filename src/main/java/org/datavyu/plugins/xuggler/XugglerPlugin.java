...
public class XugglerPlugin implements Plugin {
    ...
    public DataViewer getNewDataViewer(final Frame parent,
                                       final boolean modal) {
        return new XugglerDataViewer(parent, modal);
    }

    @Override
    public String getPluginName() {
        return "Xuggler Video";
    }
    ...
    public Class<? extends DataViewer> getViewerClass() {
        return XugglerDataViewer.class;
    }
