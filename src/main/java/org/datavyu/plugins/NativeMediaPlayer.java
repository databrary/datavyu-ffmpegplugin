...
public abstract class NativeMediaPlayer implements MediaPlayer {
    ...
    public static final double SYNC_THRESHOLD = 0.5; // 1.0 sec  (because some plugin  are not very precise in seek)
    ...
    protected abstract boolean playerIsSeekPlaybackEnabled();
