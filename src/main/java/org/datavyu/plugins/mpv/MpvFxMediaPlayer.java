...
public final class MpvFxMediaPlayer extends MpvMediaPlayer {
     ...
     * <p>
     * This seems only to work on windows
     * <p>
     * Code adopted from https://github.com/java-native-access/jna/issues/706
     *
    ...
    private static long getWindowId(Stage stage) {
        ...
        try {
            Method tkStageGetter = minor == JAVA_9 ? stageClazz.getSuperclass().getDeclaredMethod("getPeer")
