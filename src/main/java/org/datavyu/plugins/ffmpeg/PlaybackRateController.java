...
public class PlaybackRateController {
    ...
    private enum Rate {
        ...
        private final static Map<Float, Rate> VALUE_TO_RATE = new HashMap<Float, Rate>() {{
        ...
        private final static Map<Rate, Rate> NEXT_UPPER = new HashMap<Rate, Rate>() {{
        ...
        private final static Map<Rate, Rate> NEXT_LOWER = new HashMap<Rate, Rate>() {{
