...
#include <jni.h>
/* Header for class org_datavyu_plugins_ffplayer_MovieStream */

#ifndef _Included_org_datavyu_plugins_ffplayer_MovieStream
#define _Included_org_datavyu_plugins_ffplayer_MovieStream
#ifdef __cplusplus
extern "C" {
#endif
#undef org_datavyu_plugins_ffplayer_MovieStream_MIN_SPEED
#define org_datavyu_plugins_ffplayer_MovieStream_MIN_SPEED -4.0f
#undef org_datavyu_plugins_ffplayer_MovieStream_MAX_SPEED
#define org_datavyu_plugins_ffplayer_MovieStream_MAX_SPEED 4.0f
#undef org_datavyu_plugins_ffplayer_MovieStream_AUDIO_BUFFER_SIZE
#define org_datavyu_plugins_ffplayer_MovieStream_AUDIO_BUFFER_SIZE 65536L
/*
 * Class:     org_datavyu_plugins_ffplayer_MovieStream
